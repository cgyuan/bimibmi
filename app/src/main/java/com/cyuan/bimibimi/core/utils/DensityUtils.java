...
public class DensityUtils {
    ...
    // 以Pixel 3a (1080 x 2200, 440dpi, density = 440/160 = 2.75) 作为参考尺寸
    private static final float  WIDTH = 393;//参考设备的宽，单位是dp 1080/2.75

    private static float appDensity;//表示屏幕密度
    private static float appScaleDensity; //字体缩放比例，默认appDensity

    public static float targetDensity;//表示屏幕密度
